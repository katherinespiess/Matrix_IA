...
public class EntidadeCaixeiro implements EntidadeEvo<Coordenada, Double, Void> {
    ...
    GerenciadorCaixeiro ger;

    public EntidadeCaixeiro(GerenciadorCaixeiro ger) {
	this.ger = ger;
    ...
    public EntidadeCaixeiro(CodigoGenEvo<Coordenada> cG, GerenciadorCaixeiro ger) {
	this.ger = ger;
	...
	if (cG == null)
	    cG = new CodigoGenEvo<Coordenada>(ger);
	return cG;
    }
	...
	return EntidadePadrao.getRepPadrao(new Fabricar<Coordenada, Double, Void>() {
		...
		return new EntidadeCaixeiro(ger);
	    }
	}).apply(lG, qt);
    }
